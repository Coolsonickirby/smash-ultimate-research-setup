...
define regarmswitch
    ...
    color $COLOR_REGNAME
    printf "X10:"
    if ($x10 != $oldx10 && $SHOWREGCHANGES == 1)
        color_bold
        color $COLOR_REGVAL_MODIFIED
    else
        color $COLOR_REGVAL
    ...
    color $COLOR_REGNAME
    printf "X11:"
    if ($x11 != $oldx11 && $SHOWREGCHANGES == 1)
        color_bold
        color $COLOR_REGVAL_MODIFIED
    else
        color $COLOR_REGVAL
    ...
    color $COLOR_REGNAME
    printf "  X12:"
    if ($x12 != $oldx12 && $SHOWREGCHANGES == 1)
        color_bold
        color $COLOR_REGVAL_MODIFIED
    else
        color $COLOR_REGVAL
    ...
    color $COLOR_REGNAME
    printf "  X13:"
    if ($x13 != $oldx13 && $SHOWREGCHANGES == 1)
        color_bold
        color $COLOR_REGVAL_MODIFIED
    else
        color $COLOR_REGVAL
    ...
    color $COLOR_REGNAME
    printf "  X14:"
    if ($x14 != $oldx14 && $SHOWREGCHANGES == 1)
        color_bold
        color $COLOR_REGVAL_MODIFIED
    else
        color $COLOR_REGVAL
    ...
    color $COLOR_REGNAME
    printf "  X15:"
    if ($x15 != $oldx15 && $SHOWREGCHANGES == 1)
        color_bold
        color $COLOR_REGVAL_MODIFIED
    else
        color $COLOR_REGVAL
    ...
    color $COLOR_REGNAME
    printf "  X16:"
    if ($x16 != $oldx16 && $SHOWREGCHANGES == 1)
        color_bold
        color $COLOR_REGVAL_MODIFIED
    else
        color $COLOR_REGVAL
    ...
    color $COLOR_REGNAME
    printf "  X17:"
    if ($x17 != $oldx17 && $SHOWREGCHANGES == 1)
        color_bold
        color $COLOR_REGVAL_MODIFIED
    else
        color $COLOR_REGVAL
    ...
    color $COLOR_REGNAME
    printf "  X18:"
    if ($x18 != $oldx18 && $SHOWREGCHANGES == 1)
        color_bold
        color $COLOR_REGVAL_MODIFIED
    else
        color $COLOR_REGVAL
    ...
    color $COLOR_REGNAME
    printf "  X19:"
    if ($x19 != $oldx19 && $SHOWREGCHANGES == 1)
        color_bold
        color $COLOR_REGVAL_MODIFIED
    else
        color $COLOR_REGVAL
    ...
    color $COLOR_REGNAME
    printf "  X20:"
    if ($x20 != $oldx20 && $SHOWREGCHANGES == 1)
        color_bold
        color $COLOR_REGVAL_MODIFIED
    else
        color $COLOR_REGVAL
    ...
    color $COLOR_REGNAME
    printf "  X21:"
    if ($x21 != $oldx21 && $SHOWREGCHANGES == 1)
        color_bold
        color $COLOR_REGVAL_MODIFIED
    else
        color $COLOR_REGVAL
    ...
    color $COLOR_REGNAME
    printf "  X22:"
    if ($x22 != $oldx22 && $SHOWREGCHANGES == 1)
        color_bold
        color $COLOR_REGVAL_MODIFIED
    else
        color $COLOR_REGVAL
    ...
    color $COLOR_REGNAME
    printf "  X23:"
    if ($x23 != $oldx23 && $SHOWREGCHANGES == 1)
        color_bold
        color $COLOR_REGVAL_MODIFIED
    else
        color $COLOR_REGVAL
    ...
    color $COLOR_REGNAME
    printf "  X24:"
    if ($x24 != $oldx24 && $SHOWREGCHANGES == 1)
        color_bold
        color $COLOR_REGVAL_MODIFIED
    else
        color $COLOR_REGVAL
    ...
    color $COLOR_REGNAME
    printf "  X25:"
    if ($x25 != $oldx25 && $SHOWREGCHANGES == 1)
        color_bold
        color $COLOR_REGVAL_MODIFIED
    else
        color $COLOR_REGVAL
    ...
    color $COLOR_REGNAME
    printf "  X26:"
    if ($x26 != $oldx26 && $SHOWREGCHANGES == 1)
        color_bold
        color $COLOR_REGVAL_MODIFIED
    else
        color $COLOR_REGVAL
    ...
    color $COLOR_REGNAME
    printf "  X27:"
    if ($x27 != $oldx27 && $SHOWREGCHANGES == 1)
        color_bold
        color $COLOR_REGVAL_MODIFIED
    else
        color $COLOR_REGVAL
    ...
    color $COLOR_REGNAME
    printf "  X28:"
    if ($x28 != $oldx28 && $SHOWREGCHANGES == 1)
        color_bold
        color $COLOR_REGVAL_MODIFIED
    else
        color $COLOR_REGVAL
    ...
    color $COLOR_REGNAME
    printf "  X29:"
    if ($x29 != $oldx29 && $SHOWREGCHANGES == 1)
        color_bold
        color $COLOR_REGVAL_MODIFIED
    else
        color $COLOR_REGVAL
    ...
    color $COLOR_REGNAME
    printf "  X30:"
    if ($x30 != $oldx30 && $SHOWREGCHANGES == 1)
        color_bold
        color $COLOR_REGVAL_MODIFIED
    else
        color $COLOR_REGVAL
...
document regarmswitch
Syntax: regarmswitch
| Auxiliary function to display Nintendo Switch ARM registers.
end
...
| Patch a given address, converting the bytes to little-endian. Assumes input bytes are unsigned values and should be in hexadecimal format (0x...). Size must be 1, 2, 4, 8 bytes. Main purpose is to be used with the output from the asm commands.
end
